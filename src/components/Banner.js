...
function Banner({ fetchBannerData, image }) {
  ...
  useEffect(() => {
    async function fetchPopular() {
      ...
      let randomMovie =
        arrayMovies[Math.floor(Math.random() * arrayMovies.length)];
